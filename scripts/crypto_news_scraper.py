...
def get_coin_data(coin_name):
    ...
    try:
        ...
        price_url = f'https://api.coingecko.com/api/v3/simple/price?ids={coin_id}&vs_currencies=usd&include_24hr_change=true&include_last_updated_at=true'
        price_response = requests.get(price_url)
        price_data = price_response.json()[coin_id]
        
        # Coin detaylarını al
        info_url = f'https://api.coingecko.com/api/v3/coins/{coin_id}?localization=false&tickers=false&community_data=false&developer_data=false'
