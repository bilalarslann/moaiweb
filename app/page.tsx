        ...
        <div className="relative min-h-screen container mx-auto px-4 flex items-center">
          <div className="flex flex-col md:flex-row w-full items-center">
            ...
            <div className="hidden md:block absolute right-[-30%] h-screen w-[120%] top-0">
              <div className="absolute inset-0 pointer-events-none z-20" style={getGlowStyle(glowPosition2)}></div>
              <div className="absolute inset-0 pointer-events-none z-20" style={getGlowStyle(glowPosition)}></div>
            ...
            <div className="relative md:hidden w-full h-[60vh] mb-8">
              <div className="absolute inset-0 pointer-events-none z-20" style={getGlowStyle({x: glowPosition2.x / 2, y: glowPosition2.y})}></div>
              <div className="absolute inset-0 pointer-events-none z-20" style={getGlowStyle({x: glowPosition.x / 2, y: glowPosition.y})}></div>
              <div className="relative w-full h-full">
                <Image
                  src="/moai.webp"
                  alt="MOAI"
