    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <header className="w-full p-6 bg-black/30 backdrop-blur-sm border-b border-gray-800">
        <div className="flex items-center gap-4 max-w-4xl mx-auto">
          <Link href="/tr" className="text-white hover:text-blue-400 transition-colors">
          ...
          <h1 className="text-xl font-bold text-white">MOAI Destek</h1>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-800">
          ...
          <div className="text-center">
            <p className="text-gray-300 mb-4">Destek için lütfen bize e-posta gönderin:</p>
            <a 
